...
#ptc-col-servers { flex: 0 0 32%; }
#ptc-col-tuning { flex: 0 0 28%; }
#ptc-col-log { flex: 0 0 40%; }
...
.form-pair label { flex: 0 0 100px; color: var(--primary-blue); font-weight: bold; font-size: 13.5px; position: relative; cursor: help; }
...
<form method="post" autocomplete="off">
    <div id="ptc-wrapper">
        ...
        <div class="ptc-col" id="ptc-col-servers">
            <div style="margin-bottom: 20px;"><input type="submit" value="Save & Apply Settings" style="width:100%; padding:10px; font-weight:bold; text-transform:uppercase; cursor:pointer;"></div>
        ...
        <div class="ptc-col" id="ptc-col-tuning">
            ...
            <button type="button" onclick="addMappingRow()" style="padding: 6px 12px; font-size: 11px; margin-top: 10px; cursor: pointer;">+ Mapping</button>

            <div id="tuning-section">
                <div class="section-header"><i class="fa fa-cogs"></i> Tuning & Cleanup</div>
                <div class="form-pair"><label title="Seconds between checks.">Interval:</label><div class="form-input-wrapper"><input type="number" name="CHECK_INTERVAL" value="<?= $ptc_cfg['CHECK_INTERVAL'] ?>" class="ptc-input input-small"><span class="unit-label">sec</span></div></div>
                <div class="form-pair"><label title="Wait seconds before moving.">Copy Delay:</label><div class="form-input-wrapper"><input type="number" name="COPY_DELAY" value="<?= $ptc_cfg['COPY_DELAY'] ?>" class="ptc-input input-small"><span class="unit-label">sec</span></div></div>
                ...
                <div class="form-pair"><label title="Auto-remove from cache after watching.">Smart Clean:</label><div class="form-input-wrapper"><input type="checkbox" name="ENABLE_SMART_CLEANUP" value="True" <?= $ptc_cfg['ENABLE_SMART_CLEANUP'] == 'True' ? 'checked' : '' ?> ></div></div>
                <div class="form-pair"><label title="Delay before deleting watched movies.">Del Delay:</label><div class="form-input-wrapper"><input type="number" name="MOVIE_DELETE_DELAY" value="<?= $ptc_cfg['MOVIE_DELETE_DELAY'] ?>" class="ptc-input input-small"><span class="unit-label">sec</span></div></div>
        ...
        <div class="ptc-col" id="ptc-col-log">
            <div style="display:flex; justify-content:space-between; align-items:center;">
                ...
                <div style="display:flex; align-items:center; gap:8px;">
                    ...
                    <button type="button" onclick="refreshLog();" style="margin:0; padding: 4px 8px; font-size: 11px; cursor: pointer;">Refresh</button>
                </div>
            </div>
