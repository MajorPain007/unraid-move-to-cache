...
#ptc-wrapper { display: flex; flex-wrap: nowrap; align-items: flex-start; justify-content: space-between; gap: 8px; width: 100%; box-sizing: border-box; padding: 10px 0; }
...
#ptc-col-log { flex: 0 0 39%; align-self: stretch; }
...
.form-pair label { flex: 0 0 120px; color: var(--primary-blue); font-weight: bold; font-size: 13.5px; cursor: help; border-bottom: 1px dotted #444; }
...
#ptc-log { background: #000; border: 1px solid #333; border-radius: 8px; color: #00ffaa; font-family: 'Courier New', monospace; font-size: 12.5px; padding: 15px; flex-grow: 1; overflow-y: auto; white-space: pre-wrap; word-break: break-all; margin-top: 10px; height: 100%; min-height: 400px; }
