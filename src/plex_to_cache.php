...
#ptc-wrapper { display: flex; flex-wrap: nowrap; align-items: stretch; justify-content: space-between; gap: 5px; width: 100%; box-sizing: border-box; padding: 10px 0; }
...
.form-pair label { flex: 0 0 110px; color: var(--primary-blue); font-weight: bold; font-size: 14px; cursor: help; }
...
/* Right alignment for tuning column inputs only */
#tuning-section .form-input-wrapper { justify-content: flex-end; }
#tuning-section .ptc-input { text-align: right; }
...
#ptc-log { background: #000; border: 1px solid #333; border-radius: 8px; color: #00ffaa; font-family: 'Courier New', monospace; font-size: 13px; padding: 12px; flex-grow: 1; overflow-y: auto; white-space: pre-wrap; word-break: break-all; margin-top: 10px; min-height: 500px; }
...
<form method="post" autocomplete="off">
    <div id="ptc-wrapper">
        ...
        <div class="ptc-col" id="ptc-col-servers">
            ...
            <div class="form-pair"><label title="Your Plex Authentication Token.">Token:</label><div class="form-input-wrapper"><input type="password" name="PLEX_TOKEN" value="<?= $ptc_cfg['PLEX_TOKEN'] ?>" class="ptc-input" onmouseover="this.type='text'" onmouseout="this.type='password'" autocomplete="new-password"></div></div>
        ...
        <div class="ptc-col" id="ptc-col-tuning">
            ...
            <div id="tuning-section">
                ...
                <div class="form-pair"><label title="Wait this many seconds after playback starts before moving file to cache.">Copy Delay:</label><div class="form-input-wrapper"><input type="number" name="COPY_DELAY" value="<?= $ptc_cfg['COPY_DELAY'] ?>" class="ptc-input input-small"><span class="unit-label">sec</span></div></div>
